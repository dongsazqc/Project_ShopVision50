  ...
  try {
    ...
    if (storedUser?.roleId === 1) {
      ...
      Modal.warning({
        ...
        content: "Tài khoản này không có quyền truy cập trang quản trị!",
      });
    }
  } catch (err) {
            ...
            >
              <div>
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <Text style={{ fontSize: 14, lineHeight: 1.7, color: "#4b5563" }}>
                ...
                >
                  ...
                  >
                    <Input
                      ...
                      style={{ borderRadius: 999, height: 44, paddingInline: 16 }}
                    />
                  </Form.Item>
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        message.info("Liên hệ quản trị viên để cấp lại mật khẩu.")
                      }
                      style={{
                        border: "none",
                        background: "none",
