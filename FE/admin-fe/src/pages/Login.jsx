    ...
    try {
        ...
        if (!result?.success) {
            Modal.error({
                ...
                content: result?.message || "Email hoặc mật khẩu không đúng!",
            });
            return;
        }

        // Đảm bảo user đã được lưu trong localStorage
        ...
        if (storedUser.roleId === 1) {
            navigate("/admin/products"); // admin
        } else if (storedUser.roleId === 2) {
            navigate("/admin/pos"); // nhân viên
        } else {
            Modal.warning({
                title: "Không có quyền truy cập",
                content: "Tài khoản này không có quyền truy cập hệ thống quản trị!",
            });
            return; // <- bắt buộc return để không đứng ở màn đăng nhập
        }
    } catch (err) {
            ...
            >
              <div>
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  >
                    Theo dõi sản phẩm, đơn hàng và điểm bán trên cùng một nền
                    tảng dễ sử dụng.
                  </Text>
                </div>
              ...
              <div style={{ width: "100%", maxWidth: 360 }}>
                <div style={{ marginBottom: 24 }}>
                  ...
                  <Text type="secondary" style={{ fontSize: 13 }}>
                    Vui lòng dùng tài khoản đã được cấp quyền.
                  </Text>
                </div>
