            ...
            <div style={styles.heroSection}>
                <div style={styles.heroOverlay}>
                    <h1 style={styles.heroTitle}>
                        Khuyến Mãi Cực Lớn - Giảm Đến 50%
                    </h1>
                    <p style={styles.heroSubtitle}>
                        Bộ sưu tập áo phông phong cách hiện đại, chất liệu cao
                        cấp.
                    </p>
                    <Button
                        type="primary"
                ...
                <Row justify="center" style={{ marginBottom: 60 }}>
                    <Col xs={24} md={16} style={{ textAlign: "center" }}>
                        ...
                        <p style={styles.sectionText}>
                            Thời trang chất lượng – phong cách hiện đại – giá cả
                            hợp lý. StyleWear cam kết mang đến trải nghiệm tuyệt
                            vời nhất.
                        </p>
                    </Col>
                </Row>
