...
const ProductDetail = () => {
  ...
  const handleAddToCart = () => {
    if (!selectedColor || !selectedSize || !activeVariant) {
      message.warning("Vui lòng chọn màu và kích cỡ trước khi thêm vào giỏ hàng");
      return;
    }
  ...
  const styles = {
    ...
    btnAdd: { background: "#fff5f5", borderColor: "#ee4d2d", color: "#ee4d2d", flex: 1 },
    btnBuy: { background: "#ee4d2d", borderColor: "#ee4d2d", color: "#fff", flex: 1 },
          ...
          <Card style={styles.cardRadius}>
            ...
            {sizes.length > 0 && (
              <div style={styles.variantWrapper}>
                ...
                <div style={styles.sizeGuide}>Hướng dẫn chọn size: Tham khảo bảng size bên dưới.</div>
              </div>
            )}
