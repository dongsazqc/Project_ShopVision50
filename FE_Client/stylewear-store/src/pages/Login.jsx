...
import { MailOutlined, UnlockOutlined, CheckCircleOutlined } from "@ant-design/icons";
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 18, color: "#cbd5e1", maxWidth: 400 }}>
          Đăng nhập để khám phá thế giới thời trang hiện đại, nhanh chóng và an toàn.
        </p>
      </div>
      ...
      >
        ...
        >
          <h2 style={{ textAlign: "center", fontSize: 26 }}>Đăng nhập tài khoản</h2>
      ...
      >
        <Steps current={step - 1} size="small" style={{ marginBottom: 20 }}>
          ...
          <Step title="OTP & Mật khẩu mới" icon={<UnlockOutlined />} />
        ...
        {step === 1 && (
          <Form layout="vertical" onFinish={handleSendOTP}>
            ...
            >
              <Input placeholder="Nhập email để nhận OTP" size="large" />
            </Form.Item>
            <Button
              type="primary"
              htmlType="submit"
        ...
        {step === 3 && (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            <CheckCircleOutlined
              style={{ fontSize: 48, color: "#52c41a", marginBottom: 15 }}
            />
