...
const Cart = () => {
  ...
  const subtotal = selectedCartItems.reduce((sum, item) => sum + item.giaBan * item.quantity, 0);
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <Space size="middle" align="center">
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: 28, fontWeight: "bold" }}>Giỏ Hàng Của Bạn</h1>
              ...
              <Space direction="vertical" style={{ width: "100%" }}>
                {cartItems.map((item) => (
                  <Card
                    key={item.variantId}
                    hoverable
                    style={{ borderRadius: 8, background: "rgba(255,255,255,0.95)", border: "1px solid #ccc" }}
                  >
                      ...
                      <Col xs={16}>
                        <Row justify="space-between">
                          <Col>
                            ...
                            <strong style={{ color: "#667eea" }}>{formatPrice(item.giaBan)}</strong>
                          </Col>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    const checkoutItems = cartItems.filter((item) => selectedItems.includes(item.variantId));
