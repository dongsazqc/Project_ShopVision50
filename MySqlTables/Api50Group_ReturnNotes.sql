...
--
-- Table structure for table `ReturnNotes`
--

DROP TABLE IF EXISTS `ReturnNotes`;
...
CREATE TABLE `ReturnNotes` (
  ...
  PRIMARY KEY (`ReturnNoteId`),
  KEY `IX_ReturnNotes_OrderId` (`OrderId`),
...
--
-- Dumping data for table `ReturnNotes`
--

LOCK TABLES `ReturnNotes` WRITE;
/*!40000 ALTER TABLE `ReturnNotes` DISABLE KEYS */;
/*!40000 ALTER TABLE `ReturnNotes` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-11-24 12:45:58
