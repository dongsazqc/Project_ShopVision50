...
CREATE TABLE `ReturnItems` (
  ...
  `ReasonDetail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ProductVariantId` int NOT NULL,
  `ReturnNoteId` int NOT NULL,
  PRIMARY KEY (`ReturnItemId`),
  KEY `IX_ReturnItems_ProductVariantId` (`ProductVariantId`),
  KEY `IX_ReturnItems_ReturnNoteId` (`ReturnNoteId`),
...
-- Dump completed on 2025-11-24 12:44:44
